...
class SCreateVisitors extends StatefulWidget {
  final Map<String, dynamic>? visitorData;

  SCreateVisitors({super.key, this.visitorData});

  @override
  State<SCreateVisitors> createState() => _CreateVisitorsState();
}

class _CreateVisitorsState extends State<SCreateVisitors> {
