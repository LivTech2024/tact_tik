...
class SelectDARGuardsScreen extends StatefulWidget {
  ...
  const SelectDARGuardsScreen({super.key, required this.EmployeeId});
...
class _SelectGuardsScreenState extends State<SelectDARGuardsScreen> {
  ...
  Future<void> _getEmployeesByCompanyId() async {
    final querySnapshot = await FirebaseFirestore.instance
        ...
        .where("EmployeeSupervisorId", arrayContains: widget.EmployeeId)
                              ...
                              onTap: () async {
                                ...
                                if (darSnapshot.docs.isNotEmpty) {
                                  ...
                                  final String companyId =
                                      darData['EmpDarCompanyId'] ?? '';
                                  final String companyBranchId =
                                      darData['EmpDarCompanyBranchId'] ?? '';
                                  final String shiftId =
                                      darData['EmpDarShiftId'] ?? '';
                                  final String clientId =
                                      darData['EmpDarClientId'] ?? '';
                                  final String empName =
                                      darData['EmpDarEmpName'] ?? '';
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                          'No DAR data found for the selected employee.'),
