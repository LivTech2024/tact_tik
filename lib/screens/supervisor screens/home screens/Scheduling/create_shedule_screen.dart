...
class _CreateSheduleScreenState extends State<CreateSheduleScreen> {
  ...
  String? selecteBranch = 'Select Branch';
                  ...
                  child: Column(
                    ...
                    children: [
                      if (tasks.isNotEmpty)
                        ...
                        InterMedium(text: 'No tasks available.',color: Theme.of(context).textTheme.headlineMedium!.color,),
                      SizedBox(height: 20.h),
                      SizedBox(
                        width: 160.w,
                        child: Button1(
