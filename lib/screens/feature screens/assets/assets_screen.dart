...
class _AssetsScreenState extends State<AssetsScreen> {
  ...
  void initState() {
    ...
    _assetAllocationStream = FirebaseFirestore.instance
        ...
        .where('EquipmentAllocationEmpId',
        isEqualTo: widget.assetEmpId)
        .snapshots();
    }
                  ...
                  slivers: [
                    ...
                    SliverList(
                      delegate: SliverChildBuilderDelegate(
                                                ...
                                                children: [
                                                  ...
                                                  StreamBuilder<QuerySnapshot>(
                                                    ...
                                                    builder: (context, snapshot) {
                                                      String equipmentName = 'Equipment Not Available';
                                                      if (snapshot.hasData) {
                                                        final documents = snapshot.data!.docs;
                                                        equipmentName = documents.isNotEmpty
                                                            ? (documents.first.data() as Map<String, dynamic>)['EquipmentName'] ??
                        ...
                        childCount: groupDocumentsByDate(documents).keys.length + 1,
                      ),
                    ),
                  ],
                );
