                                ...
                                ...documentsByDate[date]!.map(
                                  (document) {
                                    final allocationDate = (document[
                                            ...
                                            as Timestamp)
                                        .toDate();
                                    final allocationDateTime =
                                        DateFormat.Hm().format(allocationDate);
                                    final startDate = (document[
                                                'EquipmentAllocationStartDate']
                                            as Timestamp)
                                        .toDate();
                                    final endDate =
                                        (document['EquipmentAllocationEndDate']
                                                as Timestamp)
                                            .toDate();
                                    final equipmentId =
                                        document['EquipmentAllocationEquipId'];
                                    final equipmentQty =
                                        document['EquipmentAllocationEquipQty'];
