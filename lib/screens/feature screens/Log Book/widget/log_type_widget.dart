...
class LogTypeWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return type == LogBookEnum.TotalWorkTime ? Container(
      ...
      child: Row(
        ...
        children: [
          Row(
            ...
            children: [
              Icon(
                type == LogBookEnum.ShiftStarted
                    ? Icons.directions_walk_rounded
                    : type == LogBookEnum.ShiftEnd
                        ? Icons.directions_walk_rounded
                        : type == LogBookEnum.PatrolStart
                            ? Icons.apartment_outlined
                            : type == LogBookEnum.PatrolEnd
                                ? Icons.apartment_outlined
