                          ...
                          if (selectedDate == null ||
                            ...
                            return Column(
                              ...
                              children: [
                                ...
                                InterMedium(text: 'Date', fontsize: 18.sp),
                                SizedBox(height: 20.h),
                                Column(
                                        ...
                                        NavigateScreen(
                                          ClientOpenPatrolScreen(
                                            ...
                                            endTime: DateFormat('hh:mm a')
                                                .format(endTime),
                                            patrolLogCount: patrol[
                                                    'PatrolLogPatrolCount'] ??
                                                0,
                                            status:
                                                patrol['PatrolLogStatus'] ?? '',
                                            feedback: patrol[
                                                  ...
                                                  SizedBox(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Row(
                                                          children: [
                                                            Icon(Icons.check_circle_outline, size: 20.sp,color: Theme.of(context).primaryColor,),
                                                            SizedBox(width: 4.w),
                                                            InterMedium(
                                                              text: '100',
                                                              fontsize: 14.sp,
