...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    // IconColors = Theme.of(context).brightness == Brightness.light ?
    // [IconSelected, WidgetColor, WidgetColor, WidgetColor]
    //     :[Primarycolor, color4, color4, color4];
    _getUserInfo();
    getAndPrintAllSchedules();
    // _getCurrentUserUid();
  ...
  void ChangeScreenIndex(int index) {
    setState(() {
      ...
      print("sc = $sc");
      ScreenIndex = index;
      ChangeIconColor(index,sc);
      print(IconColors[1].toString());
      print(ScreenIndex);
      if (index == 1) {
        _showWish = false;
      } else
  ...
  void ChangeIconColor(int index, int selectedIndex) {
    Color pc = IconColors[selectedIndex];
    Color c4 = IconColors[(selectedIndex+1) %4];
    setState(() {
      switch (index) {
        case 0:
          IconColors[0] = pc;
                              ...
                              children: [
                                Bounce(
                                  ...
                                  child: HomeScreenCustomNavigation(
                                    ...
                                    icon: Icons.add_task,
                                    color: IconColors[0],
                                    textcolor: ScreenIndex == 0 ? (isLight ? WidgetColor : color1) : color4,
                                  ),
                                ),
                                Bounce(
                                  ...
                                  child: HomeScreenCustomNavigation(
                                    ...
                                    color: IconColors[1],
                                    textcolor: ScreenIndex == 1 ? (isLight ? WidgetColor : color1) : color4,
                                  ),
                                ),
                                Bounce(
                                  ...
                                  child: HomeScreenCustomNavigation(
                                    ...
                                    color: IconColors[2],
                                    textcolor: ScreenIndex == 2 ? (isLight ? WidgetColor : color1) : color4,
                                  ),
                                ),
                                Bounce(
                                  child: HomeScreenCustomNavigation(
                                    ...
                                    color: IconColors[3],
                                    textcolor: ScreenIndex == 3 ? (isLight ? WidgetColor : color1) : color4,
                                  ),
                                ),
                              ],
                            ),
