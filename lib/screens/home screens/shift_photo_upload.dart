...
class ShiftPhotoUpload extends StatefulWidget {
  final String EmpId;
  final String EmpName;

  const ShiftPhotoUpload(
      {super.key, required this.EmpId, required this.EmpName});

  @override
  State<ShiftPhotoUpload> createState() => _ShiftPhotoUploadState();
}

class _ShiftPhotoUploadState extends State<ShiftPhotoUpload> {
